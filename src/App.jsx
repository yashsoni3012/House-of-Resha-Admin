...
import ManageSlots from "../src/components/ManageSlots";
import Appointment from "../src/components/Appointments";
import SlotPost from "../src/components/SlotPost";
          ...
          <Routes>
            ...
            >
              ...
              <Route path="slots" element={<Slots />}>
                ...
                <Route index element={<ManageSlots />} />
                <Route path="manage" element={<ManageSlots />} />
                <Route path="appointments" element={<Appointment />} />
                <Route path="create" element={<SlotPost />} />
              </Route>
