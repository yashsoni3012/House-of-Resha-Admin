      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-gray-100">
            ...
            <button
              onClick={handleLogoutClick}
              className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 rounded-xl transition-all duration-200 text-white shadow-md hover:shadow-lg text-sm font-semibold group"
            >
              <LogOut
                size={18}
        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full mx-auto transform transition-all animate-in zoom-in duration-200 border border-gray-100">
            ...
            <div className="flex gap-3 p-6">
              <button
                onClick={handleCancelLogout}
                className="flex-1 px-5 py-3 border-2 border-gray-200 text-gray-700 rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all font-semibold text-sm"
              >
                Cancel
              </button>
              <button
                onClick={handleConfirmLogout}
                className="flex-1 px-5 py-3 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-xl hover:from-red-600 hover:to-red-700 transition-all font-semibold text-sm flex items-center justify-center gap-2 shadow-md hover:shadow-lg"
              >
                <LogOut size={16} />
                Logout
              </button>
