...
//                   className="flex-1 bg-red-600 hover:bg-red-700 text-white px-5 py-2.5 rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
//                 >
//                   {actionLoading ? (
//                     <>
...
//                   disabled={actionLoading}
//                   className="flex-1 bg-gray-200 hover:bg-gray-300 text-gray-800 px-5 py-2.5 rounded-lg font-medium transition-colors"
//                 >
//                   Cancel
//                 </button>
//               </div>
...
//                   setExpandedId(null);
//                 }}
//                 className="bg-blue-600 hover:bg-blue-700 text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg font-medium transition-colors flex items-center justify-center gap-2 whitespace-nowrap text-sm sm:text-base"
//               >
//                 <svg
...
//               <span className="bg-blue-100 text-blue-800 text-xs sm:text-sm font-medium px-2.5 sm:px-3 py-1 rounded-full">
...
//                                 !faq.answer.trim()
//                               }
//                               className="bg-green-600 hover:bg-green-700 text-white px-4 py-2.5 sm:py-3 rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm sm:text-base"
//                             >
//                               {actionLoading ? (
//                                 <div className="animate-spin rounded-full h-4 w-4 border-t-2 border-b-2 border-white"></div>
//                               ) : (
...
//                               onClick={cancelEdit}
//                               disabled={actionLoading}
//                               className="bg-gray-200 hover:bg-gray-300 text-gray-800 px-4 py-2.5 sm:py-3 rounded-lg font-medium transition-colors flex items-center justify-center gap-2 text-sm sm:text-base"
//                             >
//                               <svg
//                                 className="w-4 h-4"
//                                 fill="none"
...
//                               className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2.5 sm:py-3 rounded-lg font-medium transition-colors flex items-center justify-center gap-2 text-sm sm:text-base"
//                             >
//                               <svg
//                                 className="w-4 h-4"
//                                 fill="none"
...
//                               }
//                               disabled={actionLoading}
//                               className="bg-red-600 hover:bg-red-700 text-white px-4 py-2.5 sm:py-3 rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm sm:text-base"
//                             >
//                               <svg
//                                 className="w-4 h-4"
//                                 fill="none"
