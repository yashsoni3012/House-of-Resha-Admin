                        ...
                        {isEditing ? (
                          ...
                          <div className="grid grid-cols-2 lg:grid-cols-1 gap-2">
                            <button
                              ...
                              className="bg-blue-600 hover:bg-blue-700 text-white px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg font-medium transition-colors flex items-center justify-center gap-2 text-sm sm:text-base"
                            >
                              <svg
                                className="w-4 h-4"
                                fill="none"
                            ...
                            <button
                              ...
                              disabled={actionLoading}
                              className="bg-red-600 hover:bg-red-700 text-white px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-sm sm:text-base"
                            >
                              <svg
                                className="w-4 h-4"
                                fill="none"
