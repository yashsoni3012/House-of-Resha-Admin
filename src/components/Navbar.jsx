...
//   // Analytics
//   { path: "/analytics", name: "Analytics", icon: "📈", category: "Overview" },
...
//   const pageTitles = {
//     "/dashboard": "Dashboard",
//     "/analytics": "Analytics", // Add this line
//     "/banners": "Banners",
//     "/add-banner": "Add Banner",
//     "/fashion": "Products",
//     "/glow-rituals": "Products",
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 lg:gap-3 relative search-container flex-shrink-0">
            ...
            <div className="relative" ref={dropdownRef}>
              <button
                ...
                className="flex items-center gap-1.5 sm:gap-2 lg:gap-3 pl-1.5 sm:pl-2 lg:pl-3 border-l border-gray-300 flex-shrink-0 hover:bg-gray-50 rounded-lg py-1 pr-1 transition-colors"
              >
                <div className="hidden md:block text-right">
                  <p className="text-xs lg:text-sm font-semibold text-gray-800 truncate max-w-[120px] lg:max-w-none">
                    {user?.name || "Admin User"}
                ...
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden z-50">
                  ...
                  <div className="px-4 py-3 border-b border-gray-100 bg-gradient-to-r from-purple-50 to-pink-50">
                    ...
                    <p className="text-xs text-gray-600 truncate">
                      {user?.email || "admin@houseofresha.com"}
                    </p>
                  </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full border">
            ...
            <div className="flex gap-3 p-6">
              <button
                ...
                className="flex-1 px-5 py-3 border-2 border-gray-200 rounded-lg font-semibold text-sm hover:bg-gray-50 transition-colors"
              >
                Cancel
              </button>
              <button
                onClick={handleConfirmLogout}
                className="flex-1 px-5 py-3 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-lg font-semibold text-sm flex items-center justify-center gap-2 hover:from-red-600 hover:to-red-700 transition-colors"
              >
                <LogOut size={16} />
                Logout
              </button>
