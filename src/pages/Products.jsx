    ...
    return (
        <div className="min-h-screen bg-gray-50">
                            ...
                            {tabs.map((tab) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {activeTab === tab.id && (
                                            <div className="ml-auto w-2 h-2 rounded-full bg-pink-600"></div>
                                        )}
                                    </button>
                                );
                            })}
                        ...
                        {tabs.map((tab) => {
                            ...
                            return (
                                <button
                                    key={tab.id}
                                    onClick={() => handleTabChange(tab.id)}
                                    className={`flex items-center gap-2 px-4 lg:px-6 py-3 lg:py-4 font-medium transition-all relative whitespace-nowrap ${isActive
                                            ? `text-${tab.color}-600`
            ...
            <div className="w-full">
                {activeTab === "fashion" ? <FashionManagement /> : <GlowRituals />}
            </div>
        </div>
    );
};
