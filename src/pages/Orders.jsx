  ...
  <div className="max-w-7xl mx-auto">
    ...
    <div className="bg-white border-b border-gray-200 px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
        ...
        {/* Right: Refresh Button (if needed) */}
        {/* <button
          onClick={fetchOrders}
    ...
    <div className="px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-4 sm:p-6 mb-6">
        <div className="flex flex-col lg:flex-row gap-4 mb-4">
          ...
          <div className="flex-1 lg:max-w-md">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 sm:pl-10 pr-10 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-sm"
              />
              {searchQuery && (
                <button
                  type="button"
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm transition-colors duration-150 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 active:scale-[0.98] whitespace-nowrap"
          >
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        ...
        <div className="bg-gray-50 px-4 sm:px-6 py-3 border-b border-gray-200 hidden lg:grid lg:grid-cols-12 gap-4 text-xs font-semibold text-gray-600 uppercase tracking-wider">
                ...
                >
                  ...
                  <div className="col-span-2 flex items-center justify-between lg:justify-end gap-3">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 sm:gap-2 px-3 py-1.5 text-blue-600 hover:bg-blue-50 rounded-lg font-medium transition-colors text-xs sm:text-sm"
                    >
