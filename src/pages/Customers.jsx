  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Search Section */}
        <div className="bg-white rounded-lg sm:rounded-xl border border-gray-200 p-4 sm:p-5 md:p-6 mb-4 sm:mb-6">
            ...
            <div className="flex-1">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 sm:pl-10 pr-9 sm:pr-10 py-2 sm:py-2.5 text-sm sm:text-base border border-gray-300 rounded-lg sm:rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all"
                />
                {searchTerm && (
                  <button
                    onClick={clearSearch}
                ...
                >
                  ...
                  <div className="flex items-start gap-2 sm:gap-3 mb-3 sm:mb-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-1.5 sm:gap-2 text-[10px] sm:text-xs text-gray-600 mb-1">
                  ...
                  {/* Contact Info */}
                  <div className="space-y-1.5 sm:space-y-2 mb-3 sm:mb-4 pb-3 sm:pb-4 border-b border-gray-100">
                  ...
                  <div className="grid grid-cols-2 gap-2 sm:gap-3 mb-3 sm:mb-4">
                    ...
                    <div className="bg-blue-50 rounded-lg p-2 sm:p-3">
                      <div className="text-[10px] sm:text-xs text-blue-600 mb-0.5 sm:mb-1">
                        Orders
                      </div>
                    ...
                    <div className="bg-green-50 rounded-lg p-2 sm:p-3">
                      ...
                      <div className="flex gap-1 mt-0.5 sm:mt-1">
                        <span className="text-[10px] sm:text-xs text-green-600 bg-green-100 px-1 sm:px-1.5 py-0.5 rounded">
                          ✓ {customer.completedOrders}
                        </span>
                        {customer.pendingOrders > 0 && (
                          <span className="text-[10px] sm:text-xs text-yellow-600 bg-yellow-100 px-1 sm:px-1.5 py-0.5 rounded">
                            ⏳ {customer.pendingOrders}
                          </span>
                        )}
                      </div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-2 sm:p-3 mb-3 sm:mb-4">
                    ...
                    <div className="text-[10px] sm:text-xs text-gray-500 capitalize mt-0.5 sm:mt-1">
                  ...
                  <button
                    onClick={() => handleViewCustomer(customer)}
                    className="w-full flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 active:scale-95 transition-all text-xs sm:text-sm font-medium"
                  >
